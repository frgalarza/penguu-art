    ...
    <main className={styles.main}>
        ...
        <div className={styles.content}>
          ...
          <ul  className={styles.ul}>
            <li className={styles.li}><Link href="/about" className={styles.button}>✦ Sobre mi ✦</Link></li>
            <li className={styles.li}><Link href="/portfolio" className={styles.button}><FaPaintBrush className={styles.icon}/>✦ Mis trabajos ✦</Link></li>
